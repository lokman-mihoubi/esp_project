...
import { User, Foncier, Document, Task, StepType } from '@/types';
...
// ================= ROLE =================
const isDG = localStorage.getItem("isDG") === "true";
...
<Dialog
  ...
  fullWidth
>
  <DialogTitle>Sélectionner les fonciers</DialogTitle>
  ...
  {/* <FormControlLabel
    control={
      <Checkbox
        ...
        onChange={(e) =>
          setFilters({ ...filters, is_completed: e.target.checked })
        }
      />
    }
    label="Terminé"
  ...
  {/* <FormControlLabel
    control={
      <Checkbox
        ...
        onChange={(e) =>
          setFilters({ ...filters, is_transmis: e.target.checked })
        }
      />
    }
    label="Transmis"
  ...
  <FormControlLabel
    control={
      <Checkbox
        ...
        onChange={(e) =>
          setFilters({ ...filters, is_published: e.target.checked })
        }
      />
    }
    label="Publié"
